...
from models import flow_mar
from engine_flow_mar import train_one_epoch, evaluate
import copy
...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='flow_mar_large', type=str, metavar='MODEL',
...
def main(args):
    ...
    model = flow_mar.__dict__[args.model](
